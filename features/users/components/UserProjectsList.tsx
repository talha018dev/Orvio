...
const UserProjectsList = ({ projectList, isLoading, isFetching, isRefetching, fetchNextPage, hasNextPage }: ProjectsListProps) => {
                                    ...
                                    >
                                        ...
                                        <div className='flex items-center space-x-2 mt-3'>
                                            <AvatarCircles
                                                ...
                                                avatarUrls={project?.collaborators?.slice(0, 3)?.map((collaborator: any) => {
                                                    const getInitials = collaborator?.name.split(' ').slice(0, 2).map((word: any) => word[0]).join('').toUpperCase();
                                                    return {
